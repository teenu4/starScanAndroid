...
import com.sevenkapps.moviesearchandroid.requests.TokenRequests;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginButton.registerCallback(callbackManager, new FacebookCallback<LoginResult>() {
            ...
            public void onSuccess(LoginResult loginResult) {
                TokenRequests.getTokenFromServer(getApplicationContext(), Constants.AUTH_TYPE_FACEBOOK, loginResult.getAccessToken().getToken());
            }
