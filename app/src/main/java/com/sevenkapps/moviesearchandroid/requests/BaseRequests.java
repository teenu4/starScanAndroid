...
//                return hv.verify("localhost:3000", session);
    ...
    protected static SSLSocketFactory getSSLSocketFactory(Context context)
        ...
        InputStream caInput = context.getResources().openRawResource(R.raw.localhost); // this cert file stored in \app\src\main\res\raw folder path
    ...
    protected static HurlStack getHurlStack(final Context context) {
